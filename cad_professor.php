  ...
  <div class="container-fluid">
    ...
    <div id=divform>
        ...
        <form name="form" method="POST" action="conexao_pro.php">
         ...
         Nome: <input id="textnome" type="text" name="nomeusuario" size="40" placeholder="Nome"required="true"/><br/>
         ...
         Disciplina: <input id="textdisciplina" type="text" name="disciplina" size="40" placeholder="Disciplina"required="true"/><br/>
         </FONT></p>
